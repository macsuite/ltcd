...
func (view *UtxoViewpoint) AddTxOuts(tx *macutil.Tx, blockHeight int32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *macutil.Tx, blockHeight int32, stxos *[]spentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *macutil.Block, stxos *[]spentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(block *macutil.Block, stxos []spentTxOut) error {
...
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block *macutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *macutil.Tx) (*UtxoViewpoint, error) {
	b.chainLock.RLock()
