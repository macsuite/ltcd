...
// is the zeroHash.
func BuildMerkleTreeStore(transactions []*macutil.Tx, witness bool) []*chainhash.Hash {
...
func ExtractWitnessCommitment(tx *macutil.Tx) ([]byte, bool) {
...
func ValidateWitnessCommitment(blk *macutil.Block) error {
