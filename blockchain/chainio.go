...
// txouts.
func dbFetchSpendJournalEntry(dbTx database.Tx, block *macutil.Block, view *UtxoViewpoint) ([]spentTxOut, error) {
...
func (b *BlockChain) createChainState() error {
	...
	genesisBlock := macutil.NewBlock(b.chainParams.GenesisBlock)
...
func (b *BlockChain) initChainState() error {
	...
	err := b.db.View(func(dbTx database.Tx) error {
		...
		blockWeight := uint64(GetBlockWeight(macutil.NewBlock(&block)))
...
// raw block for the provided node, deserialize it, and return a macutil.Block
// with the height set.
func dbFetchBlockByNode(dbTx database.Tx, node *blockNode) (*macutil.Block, error) {
...
func (b *BlockChain) BlockByHeight(blockHeight int32) (*macutil.Block, error) {
...
//
// This function is safe for concurrent access.
func (b *BlockChain) BlockByHash(hash *chainhash.Hash) (*macutil.Block, error) {
