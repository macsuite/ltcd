...
func GetBlockWeight(blk *macutil.Block) int64 {
...
func GetTransactionWeight(tx *macutil.Tx) int64 {
	msgTx := tx.MsgTx()
...
func GetSigOpCost(tx *macutil.Tx, isCoinBaseTx bool, utxoView *UtxoViewpoint,
