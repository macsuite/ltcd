...
func addNaTests() {
	// IPv4
	// Localhost
	addNaTest("127.0.0.1", 40333, "127.0.0.1:40333")
	addNaTest("127.0.0.1", 9334, "127.0.0.1:9334")

	// Class A
	addNaTest("1.0.0.1", 40333, "1.0.0.1:40333")
	...
	// Private Class B
	addNaTest("172.16.0.1", 40333, "172.16.0.1:40333")
	...
	// Class C
	addNaTest("193.0.0.1", 40333, "193.0.0.1:40333")
	...
	// Private Class C
	addNaTest("192.168.0.1", 40333, "192.168.0.1:40333")
...
func TestAttempt(t *testing.T) {
	...
	err := n.AddAddressByIP(someIP + ":40333")
	if err != nil {
...
func TestNeedMoreAddresses(t *testing.T) {
	...
	for i := 0; i < addrsToAdd; i++ {
		s := fmt.Sprintf("%d.%d.173.147:40333", i/128+60, i%128+60)
	...
	srcAddr := wire.NewNetAddressIPPort(net.IPv4(173, 144, 173, 111), 40333, 0)
...
func TestGood(t *testing.T) {
	...
	var err error
	for i := 0; i < addrsToAdd; i++ {
		s := fmt.Sprintf("%d.173.147.%d:40333", i/64+60, i%64+60)
		addrs[i], err = n.DeserializeNetAddress(s)
		if err != nil {
			t.Errorf("Failed to turn %s into an address: %v", s, err)
		}
