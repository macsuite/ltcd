...
func createCoinbaseTx(coinbaseScript []byte, nextBlockHeight int32,
	addr macutil.Address, mineTo []wire.TxOut,
	net *chaincfg.Params) (*macutil.Tx, error) {
...
func CreateBlock(prevBlock *macutil.Block, inclusionTxs []*macutil.Tx,
	blockVersion int32, blockTime time.Time, miningAddr macutil.Address,
	mineTo []wire.TxOut, net *chaincfg.Params) (*macutil.Block, error) {
	...
	blockTxns := []*macutil.Tx{coinbaseTx}
	if inclusionTxs != nil {
	...
	utilBlock := macutil.NewBlock(&block)
