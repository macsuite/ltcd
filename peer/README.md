...
(http://godoc.org/github.com/macsuite/macd/peer)
...
```bash
$ go get -u github.com/macsuite/macd/peer
```

## Examples

* [New Outbound Peer Example]
  (https://godoc.org/github.com/macsuite/macd/peer#example-package--NewOutboundPeer)  
