...
//
// NOTE: This is a macd extension.
func (c *Client) ListAddressTransactionsAsync(addresses []macutil.Address, account string) FutureListAddressTransactionsResult {
...
//
// NOTE: This is a btcwallet extension.
func (c *Client) ListAddressTransactions(addresses []macutil.Address, account string) ([]btcjson.ListTransactionsResult, error) {
