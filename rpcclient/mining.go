...
func (c *Client) SubmitBlockAsync(block *macutil.Block, options *btcjson.SubmitBlockOptions) FutureSubmitBlockResult {
	blockHex := ""
	if block != nil {
...
func (c *Client) SubmitBlock(block *macutil.Block, options *btcjson.SubmitBlockOptions) error {
