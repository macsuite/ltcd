...
// a slice of them.
func loadBlocks(t *testing.T, dataFile string, network wire.BitcoinNet) ([]*macutil.Block, error) {
	...
	blocks := make([]*macutil.Block, 0, 256)
	genesis := macutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
