...
reason, the macd suite has a formalized and rigorous development process which
...
- [Effective Go](http://golang.org/doc/effective_go.html) - The entire macd
...
One of the major design goals of all core macd packages is to aim for complete
...
commits](https://github.com/macsuite/macd/commits/master) for examples of
commit messages.
...
contributions.  This is how to get your changes into macd.
...
Rejoice as you will now be listed as a [contributor](https://github.com/macsuite/macd/graphs/contributors)!
...
[ISC license](https://github.com/macsuite/macd/blob/master/LICENSE).  This is
the same license as all of the code in the macd suite.
