...
import (
	...
	peerpkg "github.com/macsuite/macd/peer"
...
type PeerNotifier interface {
	...
	TransactionConfirmed(tx *macutil.Tx)
}
...
func (b *blockManager) handleBlockchainNotification(notification *blockchain.Notification) {
	...
	case blockchain.NTBlockAccepted:
		...
		block, ok := notification.Data.(*macutil.Block)
		if !ok {
...
// processed.
func (b *blockManager) QueueTx(tx *macutil.Tx, peer *peerpkg.Peer, done chan struct{}) {
...
// processed.
func (b *blockManager) QueueBlock(block *macutil.Block, peer *peerpkg.Peer, done chan struct{}) {
...
func (b *blockManager) ProcessBlock(block *macutil.Block, flags blockchain.BehaviorFlags) (bool, error) {
